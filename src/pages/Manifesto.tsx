...
const styleClasses: Record<ParagraphStyle, string> = {
  statement: "text-[22px] md:text-[26px] font-semibold text-[hsl(228,20%,10%)] mt-14 md:mt-16",
  narrative: "text-[16px] md:text-[18px] text-[hsl(220,10%,25%)] mt-8 md:mt-10",
  supporting: "text-[15px] md:text-[16px] text-[hsl(220,8%,50%)] mt-8 md:mt-10",
};
